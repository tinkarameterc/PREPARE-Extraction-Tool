...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_vocabulary_user_id"), "vocabulary", ["user_id"], unique=False
    )
    op.create_table(
        "cluster",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_extractionjob_dataset_id"),
        "extractionjob",
        ["dataset_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_extractionjob_status"), "extractionjob", ["status"], unique=False
    )
    op.create_table(
        "record",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_cluster_merge_suggestion_cluster_a_id"),
        "cluster_merge_suggestion",
        ["cluster_a_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cluster_merge_suggestion_cluster_b_id"),
        "cluster_merge_suggestion",
        ["cluster_b_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cluster_merge_suggestion_dataset_id"),
        "cluster_merge_suggestion",
        ["dataset_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cluster_merge_suggestion_label"),
        "cluster_merge_suggestion",
        ["label"],
        unique=False,
    )
    op.create_index(
        op.f("ix_cluster_merge_suggestion_status"),
        "cluster_merge_suggestion",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sentence_segment_record_id"),
        "sentence_segment",
        ["record_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["linked_date_term_id"], ["source_term.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["record_id"], ["record.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["sentence_segment_id"], ["sentence_segment.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_cluster_merge_suggestion_status"),
        table_name="cluster_merge_suggestion",
    )
    op.drop_index(
        op.f("ix_cluster_merge_suggestion_label"), table_name="cluster_merge_suggestion"
    )
    op.drop_index(
        op.f("ix_cluster_merge_suggestion_dataset_id"),
        table_name="cluster_merge_suggestion",
